...
class ProductImage extends Model
{
    ...
    protected $primaryKey = ['product_id', 'type'];
    ...
    public function getImageUrlAttribute()
    {
        ...
        return url(Storage::disk('products')->url($this->product_id . '/' . $this->type . '.' . $this->mime2ext($this->extension))) . '?updated=' . Carbon::parse($this->updated_at)->format('YmdHis');
