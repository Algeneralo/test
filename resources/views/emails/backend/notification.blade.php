    ...
    <tr>
        <td class="o_ereset o_bg-dark o_px" align="center">
            ...
            <table class="o_block" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                <tr>
                    <td class="o_ereset o_bg-default o_bg-center o_br o_px-md o_py-lg" align="center" background="images/hero_lines-color.png">
                        <!--[if mso]>
                                ...
                                <table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr>
                                        <td class="o_bg-white o_text o_text-sans o_text-dark o_p-icon o_br-max">
                                            <img class="o_br-max" src="{{ $message->embed(storage_path('app/email/icon_notifications.gif'))}}" width="88" height="88" alt="Ringing Bell" style="max-width: 88px;" />
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                <h3 class="o_text-headline o_text-white o_mt-md o_mb-xs">{{$title}}</h3>
                                <p class="o_text o_text-sans o_text-white o_mb-lg">{{$desc}}</p>
                            </div>
                        </div>
                        <!--[if mso]>
                        </td>
