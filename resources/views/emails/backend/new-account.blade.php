...
<table class="o_esec" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;">
    ...
    <tr>
        <td class="o_ereset o_bg-dark o_hide" style="line-height: 0;display: none;font-size: 0 !important;max-height: 0;width: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
            <div>@lang('emails.new_account_admin.title')</div>
            <div>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </td>
                ...
                <tr>
                    ...
                    <!--<div class="o_col o_col-4 o_text-right o_text-xs-center">
                            <div class="o_px-xs">
                                ...
                                <p class="o_text-headline o_text-xxs o_text-muted"><a class="o_text-white o_link" href="#"><span>@lang('emails.new_account_admin.title')</span></a></p>
                        ...
                        <div class="o_px-xs o_text-center">
                            ...
                            <h1 class="o_text-headline o_text-white o_mt-md o_mb-xs">@lang('emails.new_account_admin.title')</h1>
                            <p class="o_text-lg o_text-sans o_text-white o_mb-lg">@lang('emails.new_account_admin.desc')</p>
                            <table class="o_btn" role="presentation" align="center" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td class="o_pbtn o_text-md o_br-max o_bg-white" align="center">
                                        <a class="o_text-headline o_text-dark" href="{{$url}}"><span>@lang('emails.new_account_admin.button')</span></a>
                                    </td>
                                </tr>
                                </tbody>
                                {{$url}}
