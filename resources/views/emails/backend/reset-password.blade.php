...
<table class="o_esec" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;">
    ...
    <tr>
        <td class="o_ereset o_bg-dark o_hide" style="line-height: 0;display: none;font-size: 0 !important;max-height: 0;width: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
            <div>@lang('emails.reset_password_admin.title')</div>
            <div>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </td>
        ...
        <td class="o_ereset o_bg-dark o_pt-lg o_px" align="center">
            ...
            <table role="presentation" width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                    <td align="left">
            <![endif]-->
            <table class="o_block" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                <tr>
                    <td class="o_ereset o_bg-default o_bg-center o_br o_px-md o_py-lg o_text-xs-center" align="left" background="images/hero_lines-color.png">
                        <!--[if mso]>
                        <table role="presentation" width="552" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                            <tr>
                                <td width="184" align="left" style="padding: 0 8px;">
                        <![endif]-->
                        <div class="o_col o_col-2 o_text-left o_text-xs-center">
                            <div class="o_px-xs">
                                <p class="o_text o_text-sans"><a class="o_text-white o_link" href="#">
                                        <img src="{{ $message->embed(storage_path('app/email/logo.png')) }}" width="52" height="44" alt="TL;DR" style="max-width: 52px;" />
                                    </a>
                                </p>
                        ...
                        <td width="368" align="right" style="padding: 0 8px;">
                        <![endif]-->
                        <!--<div class="o_col o_col-4 o_text-right o_text-xs-center">
                            <div class="o_px-xs">
                                <div style="font-size: 8px; line-height: 8px; height: 8px;">&nbsp; </div>
                                <p class="o_text-headline o_text-xxs o_text-muted"><a class="o_text-white o_link" href="#"><span>@lang('emails.reset_password_admin.title')</span></a></p>
                        ...
                        <tr>
                            <td colspan="2" align="center" style="padding: 0 8px;">
                        <![endif]-->
                        <div style="font-size: 16px; line-height: 16px; height: 16px;">&nbsp; </div>
                        <div class="o_px-xs o_text-center">
                            <table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                <tr>
                                    <td class="o_bg-white o_text o_text-sans o_text-dark o_p-icon o_br-max" align="center">
                                        <img class="o_br-max" src="{{ $message->embed(storage_path('app/email/icon_lock.gif'))}}" width="88" height="88" alt="Warning" style="max-width: 88px;" />
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            <h1 class="o_text-headline o_text-white o_mt-md o_mb-xs">@lang('emails.reset_password_admin.title')</h1>
                            <p class="o_text-lg o_text-sans o_text-white o_mb-lg">@lang('emails.reset_password_admin.desc')</p>
                            <table class="o_btn" role="presentation" align="center" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                <tr>
                                    <td class="o_pbtn o_text-md o_br-max o_bg-white" align="center">
                                        <a class="o_text-headline o_text-dark" href="{{$url}}"><span>@lang('emails.reset_password_admin.button')</span></a>
                                    </td>
