...
@section('title', 'Newsletter bearbeiten')
...
@section('content')
    <h2 class="content-heading">
        <i class="fa fa-envelope"></i> Newsletter bearbeiten
    </h2>

    <form class="block block-form" method="post"
          action="{{route('post.newsletter-update', ['newsletter' => $newsletter->id])}}">
        @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="receiver"
                                value="{{ (old('receiver')) ? old('receiver') : $newsletter->receiver }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subject"
                               value="{{ (old('subject')) ? old('subject') : $newsletter->subject }}">
                        @error('subject')
                        <small class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="message" class="summernote">
                            {{ (old('message')) ? old('message') : $newsletter->message }}
                        </textarea>
                        @error('message')
                        <small class="form-text text-danger">{{$message}}</small>
                        @enderror
