...
@section('content')
    ...
    <h2 class="content-heading">
        <i class="scannel-icons icon-product"></i> Offene Scannel Produkte
        @can('open-products.edit')
            <button class="btn btn-alt-primary pull-right" onclick="location.href='{{ url('scannel/openproduct') }}'">+
                Produkt hinzufügen
            </button>
        @endcan
    </h2>
            ...
            <table class="table dataTable scannel-datatable">
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        @canany(['open-products.edit'])
                            <td>
                                @can('open-products.edit')<a class="edit-link delete-product" href="javascript:void(0)"
                                                             data-delurl="{{route('get.scannelproductdelete', ['del' => $product->product_id])}}"><i
                                        class="fa fa-trash"></i></a>@endcan
