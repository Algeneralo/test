            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li class="nav-main-heading">
                        <span class="sidebar-mini-visible"></span><span class="sidebar-mini-hidden">Benutzer</span>
                    </li>
                            ...
                            <ul>
                                <li>
                                    <a class="{{ request()->is('app-users/*') ? ' active' : '' }}"
                                       href="{{route('get.app-users')}}">Nutzer</a>
                                </li>
                            <!--<li>
                        ...
                        <li>
                            <a class="{{ (request()->is('newsletter') ||  request()->is('newsletter/*')) ? ' active' : '' }}"
                               href="{{route('get.newsletters')}}">
                                <i class="si si-envelope"></i><span class="sidebar-mini-hide">Newsletter</span>
                            </a>
                        </li>
                    @endcan
                ...
                <!-- Scannel sub navi-->
                    @canany(['scannel-products.read', 'ingredients.read'])
                        <li class="nav-main-heading">
                            <span class="sidebar-mini-visible"></span><span class="sidebar-mini-hidden">Scannel</span>
                        </li>
                                    ...
                                    @can('ingredients.food')
                                        <li>
                                            <a class="{{ (request()->is('scannel/ingredient/ingredientgroups/food') ||  request()->is('admin/users/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.ingredientgroups', ['category' => 'food'])}}">Lebensmittel</a>
                                        </li>
                                    @endcan
                                    @can('ingredients.cosmetics')
                                        <li>
                                            <a class="{{ (request()->is('scannel/ingredient/ingredientgroups/cosmetics') ||  request()->is('admin/groups/*'))  ? ' active' : '' }}"
                                               href="{{route('get.scannel.ingredientgroups', ['category' => 'cosmetics'])}}">Kosmetika</a>
                                        </li>
                                    @endcan
                                    @can('ingredients.feed')
                                        <li>
                                            <a class="{{ (request()->is('scannel/ingredient/ingredientgroups/feed') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.ingredientgroups', ['category' => 'feed'])}}">Futtermittel</a>
                                        </li>
                                    @endcan
                                    @can('ingredients.cleanser')
                                        <li>
                                            <a class="{{ (request()->is('scannel/ingredient/ingredientgroups/cleanser') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.ingredientgroups', ['category' => 'cleanser'])}}">Reinigungsmittel</a>
                                        </li>
                                    @endcan
                                </ul>
                            </li>
                        ...
                        <li>
                            <a href="{{route('get.scata.producers')}}"
                               class="{{ (request()->is('scata/producers') ||  request()->is('scata/producers/*') || request()->is('scata/create-producer')) ? ' active' : '' }}">
                                <i class="icon-product"></i><span class="sidebar-mini-hide">Hersteller</span>
                            </a>
                        </li>
                        @endcanany
                            ...
                            <li>
                                <a href="{{route('get.scata.qualities')}}"
                                   class="{{ (request()->is('scata/qualities') ||  request()->is('scata/quality/*') || request()->is('scata/create-quality')) ? ' active' : '' }}">
                                    <i class="icon-product"></i><span class="sidebar-mini-hide">Gütesiegel</span>
                                </a>
                            </li>
                        @endcanany
                    @endcanany
                    ...
                    @canany(['scata-products.read', 'scata-products.edit', 'scata-products.delete', 'open-products.read', 'open-products.edit', 'open-products.delete', 'bot-products.read', 'bot-products.edit', 'bot-products.delete'])
                        <li class="nav-main-heading">
                            <span class="sidebar-mini-visible"></span><span
                                class="sidebar-mini-hidden"> IN PROCESSING </span>
                        </li>
                                    ...
                                    @can('products.food')
                                        <li>
                                            <a class="{{ (request()->is('scannel/openproducts/food') ||  request()->is('admin/users/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.openproducts', ['category' => 'food'])}}">Lebensmittel</a>
                                        </li>
                                    @endcan
                                    @can('products.cosmetics')
                                        <li>
                                            <a class="{{ (request()->is('scannel/openproducts/cosmetics') ||  request()->is('admin/groups/*'))  ? ' active' : '' }}"
                                               href="{{route('get.scannel.openproducts', ['category' => 'cosmetics'])}}">Kosmetika</a>
                                        </li>
                                    @endcan
                                    @can('products.feed')
                                        <li>
                                            <a class="{{ (request()->is('scannel/openproducts/feed') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.openproducts', ['category' => 'feed'])}}">Futtermittel</a>
                                        </li>
                                    @endcan
                                    @can('products.cleanser')
                                        <li>
                                            <a class="{{ (request()->is('scannel/openproducts/cleanser') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.openproducts', ['category' => 'cleanser'])}}">Reinigungsmittel</a>
                                        </li>
                                    @endcan
                                </ul>
                            </li>
                                    ...
                                    @can('products.food')
                                        <li>
                                            <a class="{{ (request()->is('scata/products/food') ||  request()->is('admin/users/*')) ? ' active' : '' }}"
                                               href="{{route('get.scata.products', ['category' => 'food'])}}">Lebensmittel</a>
                                        </li>
                                    @endcan
                                    @can('products.cosmetics')
                                        <li>
                                            <a class="{{ (request()->is('scata/products/cosmetics') ||  request()->is('admin/groups/*'))  ? ' active' : '' }}"
                                               href="{{route('get.scata.products', ['category' => 'cosmetics'])}}">Kosmetika</a>
                                        </li>
                                    @endcan
                                    @can('products.feed')
                                        <li>
                                            <a class="{{ (request()->is('scata/products/feed') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scata.products', ['category' => 'feed'])}}">Futtermittel</a>
                                        </li>
                                    @endcan
                                    @can('products.cleanser')
                                        <li>
                                            <a class="{{ (request()->is('scata/products/cleanser') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scata.products', ['category' => 'cleanser'])}}">Reinigungsmittel</a>
                                        </li>
                                    @endcan
                                </ul>
                            </li>
                                    ...
                                    @can('products.food')
                                        <li>
                                            <a class="{{ (request()->is('scannel/bot/products/food') ||  request()->is('admin/users/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.bot.products', ['category' => 'food'])}}">Lebensmittel</a>
                                        </li>
                                    @endcan
                                    @can('products.cosmetics')
                                        <li>
                                            <a class="{{ (request()->is('scannel/bot/products/cosmetics') ||  request()->is('admin/groups/*'))  ? ' active' : '' }}"
                                               href="{{route('get.scannel.bot.products', ['category' => 'cosmetics'])}}">Kosmetika</a>
                                        </li>
                                    @endcan
                                    @can('products.feed')
                                        <li>
                                            <a class="{{ (request()->is('scannel/bot/products/feed') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.bot.products', ['category' => 'feed'])}}">Futtermittel</a>
                                        </li>
                                    @endcan
                                    @can('products.cleanser')
                                        <li>
                                            <a class="{{ (request()->is('scannel/bot/products/cleanser') ||  request()->is('admin/roles/*')) ? ' active' : '' }}"
                                               href="{{route('get.scannel.bot.products', ['category' => 'cleanser'])}}">Reinigungsmittel</a>
                                        </li>
                                    @endcan
                                </ul>
                            </li>
                    ...
                    @if(Gate::allows('viewTelescope'))
                        <li class="nav-main-heading">
                            <span class="sidebar-mini-visible"></span><span
                                class="sidebar-mini-hidden">Sonstiges</span>
                        </li>
                    @endif
                    ...
                    @if(Gate::allows('viewTelescope'))
                        <li>
                            <a href="{{route('telescope')}}">
                                <i class="si si-rocket"></i><span class="sidebar-mini-hide">Logs</span>
                            </a>
                        </li>
                @endif
                <!--<li>
    ...
    <footer id="page-footer" class="opacity-0">
        <div class="content py-20 font-size-sm clearfix">
            <div class="float-left">
                <a class="font-w600" href="#" target="_blank">Scannel</a> &copy; <span class="js-year-copy"></span>
            </div>
        </div>
    </footer>
    <!-- END Footer -->
