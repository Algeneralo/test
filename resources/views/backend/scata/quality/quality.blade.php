...
@section('content')
    <h2 class="content-heading">
        <i class="scannel-icons icon-product"></i> Gütesiegel: {{$quality->name}}
    </h2>



    <!-- Dynamic Table Full -->
    <form class="row" action="{{route('post.scata.quality-update', ['qualitySeal' => $quality->id])}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Produkt -->
        <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="description">{{$quality->description}}</textarea>
                                @error('description')
                                <small class="form-text text-danger">{{$message}}</small>
                                @enderror
                            </div>
        ...
        <div class="col-md-3">
            <div class="block block-form">
                ...
                <div class="block-content block-content-full quality-logo text-center">
                    @if($quality->logo)
                        <img class="img-avatar img-avatar96 img-avatar-thumb" src="{{$quality->logoUrl}}" alt="">
                    @else
