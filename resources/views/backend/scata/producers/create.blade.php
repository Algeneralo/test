...
@section('title', 'Hersteller hinzufügen')
...
@section('content')
    <h2 class="content-heading">
        <i class="scannel-icons icon-product"></i> Hersteller hinzufügen
    </h2>



    <!-- Dynamic Table Full -->
    <form class="row" action="{{route('post.scata.producer-create')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Produkt -->
        <div class="col-md-12">
